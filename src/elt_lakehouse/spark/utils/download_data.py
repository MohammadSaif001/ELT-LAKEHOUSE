...
def download_dataset(
    DATASET_ID="olistbr/brazilian-ecommerce", DATASET_DOWNLOAD_PATH="data/raw/olist"
):
    ...
    try:
        kaggle.api.dataset_download_files(
            DATASET_ID, path=DATASET_DOWNLOAD_PATH, unzip=True
        )
        print(
            f"Dataset '{DATASET_ID}' downloaded and extracted to '{DATASET_DOWNLOAD_PATH}'"
        )
