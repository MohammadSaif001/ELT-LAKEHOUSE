...
def bronze_runner() -> None:
    ...
    genrators: list[tuple[str,Callable]] = [
    ...
    try:
        for dataset_name, ingestion_function in genrators:
        ...
        logger.info("All ingestion functions completed successfully in duration_s=%.2f", duration_seconds)
    except Exception:
