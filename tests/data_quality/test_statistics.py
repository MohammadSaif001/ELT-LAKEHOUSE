...
def test_payment_type_distribution():
    historical = load_distribution("payment_type_distribution.json")
...
def test_product_category_distribution():
    historical = load_distribution("product_category_distribution.json")
...
def test_review_score_distribution():
    historical = load_distribution("review_score_distribution.json")
